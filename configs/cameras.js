export const CAMERAS = {
  ...
  Cam_Side: {
    position: [-0.8482480, -0.0257676, -0.0885333],
    quaternion: [0.0, -0.7071068, 0.0, 0.7071068],
    fov: 14.4263
  },

  Cam_Camera: {
    position: [-0.3419713, 0.1106067, 0.2795201],
    quaternion: [-0.1311835, -0.3724838, -0.0532764, 0.9171741],
    fov: 14.4263
  },

  Cam_Capture: {
    position: [-0.3173451, 0.2082596, 0.1994210],
    quaternion: [-0.2376083, -0.4031049, -0.1092150, 0.8769953],
    fov: 14.4263
  },

  Cam_Power: {
    position: [0.4209688, 0.1141841, 0.2058282],
